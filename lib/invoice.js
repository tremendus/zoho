...
// Update Record
Invoice.prototype.updateRecord = function (module, id, params, callback, endpointSuffix) {
  params = params || {};
  ...
  _endpoint = [module, id, endpointSuffix].join('/')


  this._request('PUT', _endpoint, { JSONString: JSON.stringify(params) }, callback);
};
